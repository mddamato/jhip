(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('countryCodeLookupApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-countryCodeLookupApp-error');
                var entityKey = httpResponse.headers('X-countryCodeLookupApp-params');
                if (errorHeader) {
